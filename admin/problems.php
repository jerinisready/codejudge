    ...
    <div class="container">
      ...
      <div>
        <div>
          ...
          <form method="post" action="update.php">
				...
				<div class="tab-content">
					...
					<div class="tab-pane active" id="tab1">
						...
						<div class="input-append">
						Points : <input class="span2" id="point" size="8" type="text" name="points" value="<?php echo($selected['points']); ?>"><span class="add-on">pts</span>
            </div>
          </div>
          <br/>
          ...
          <textarea style="font-family: mono; width:785px; height:400px;" name="input" id="input" value="<?php echo $selected['input'];?>"><?php echo $selected['input'];?></textarea><br/>
          </div>
          
		  <div class="tab-pane" id="tab3">
          <textarea style="font-family: mono; width:785px; height:400px;" name="output" id="output" value="<?php echo $selected['output'];?>"><?php echo $selected['output'];?></textarea><br/>
          </div>
          </div>
          ...
          <div class="controls">
            ...
            <div class="input-append">
              Points: <input class="span2" id="point" size="8" type="text" name="points"><span class="add-on">pts</span>
            </div>
          </div>
          <br/>
